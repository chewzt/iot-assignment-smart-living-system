...
// =====================================================
// SMART HOME LIVING SYSTEM - TRIGGER PRIORITY VERSION
//
// New behavior:
// 1. Smoke always overrides buzzer, fan, LED
// 2. Temperature always overrides fan, curtain
// 3. Light always overrides LED, curtain
// 4. Manual commands apply only when no relevant trigger is active
// 5. Auto mode follows normal automation when no trigger override
// =====================================================
...
int SMOKE_CLEAR_THRESHOLD = 1200;
...
void printStatus() {
  Serial.println("==================================");
  Serial.println("Firebase-Integrated Smart Home - Trigger Priority");
  ...
  Serial.print("Buzzer="); Serial.print(buzzerTarget);
  Serial.print(" LED="); Serial.print(ledTarget);
  Serial.print(" Fan="); Serial.print(fanTarget);
  Serial.print(" Curtain="); Serial.println(curtainTarget);
...
void setup() {
  ...
  Serial.println("ESP32 Firebase-Integrated Smart Home - Trigger Priority");
